...
def handle_value(my_val: int | float | str,
                 first_row: bool=False) -> str:
    """Handles formatting of a value for the MESA mock profile file.
...
class ExpectedMESAProfileData:
    ...
    def get_dict(cls) -> dict[str, typing.Any]:
        ...
        -------
        dict[str, typing.Any]
            Contains all attributes of this class.
        """
        return {
            a: getattr(cls, a)
