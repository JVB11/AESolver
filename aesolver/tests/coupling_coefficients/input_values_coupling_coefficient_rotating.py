'''Python module containing the input values for the CouplingCoefficientRotating class of the aesolver.coupling_coefficients module.
...
class InputCouplingCoefficientRotating:
