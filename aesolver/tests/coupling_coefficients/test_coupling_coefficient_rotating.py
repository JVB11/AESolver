'''Pytest module that tests the superclass 'CouplingCoefficientRotating' of the aesolver.coupling_coefficients module
...
from input_values_coupling_coefficient_rotating \
    import InputCouplingCoefficientRotating as ICcR
# import expected value modules
from expected_values_coupling_coefficient_rotating \
    import AttributesCouplingCoefficientRotatingAfterInit \
        as ACCRai
...
class TestCouplingCoefficientRotating:
    """Tests the 'CouplingCoefficientRotating' class."""
    ...
    # test initialization
    def test_init_ccr(self):
        """Tests initialization of the CouplingCoefficientRotating object."""
    ...
    def test_attrs_after_init(self):
        """Tests the values of the attributes of the CouplingCoefficientRotating object directly after initialization."""
        # initialize the object
        my_obj = CCR(
            **self.default_input_dict
            )
