'''Python module containing the expected values for the CouplingCoefficientRotating class of the aesolver.coupling_coefficients module.
...
# CouplingCoefficientRotating class
# -- directly after initialization
class AttributesCouplingCoefficientRotatingAfterInit:
    """Contains the attributes of the CouplingCoefficientRotating after initialization of the module."""
    ...
    _nr_modes: int=3
    _norm_P: np.float64=1.0
    _norm_rho: np.float64=1.0
